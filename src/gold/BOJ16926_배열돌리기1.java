	...
	static void move() {
		...
		for (int d = 0; d < depth; d++) {
			...
			for (int i = 0; i < rLen-1; i++) {
				...
				while(--cnt>0) {
					if((r==d&&c==d)||(r==d&&c==d+cLen-1)||(r==d+rLen-1&&c==d)||(r==d+rLen-1&&c==d+cLen-1))//check(ro,co,dir%4)
						dir++;
					
					r+= dr[dir%4];
					c+= dc[dir%4];
					//System.out.println(r+", "+c+", "+(dir%4));
				}
